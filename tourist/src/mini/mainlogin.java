...
JLabel lblNewLabel_2 = new JLabel("       WELCOME TO OUR TOURIST PLACES GENERATOR");
lblNewLabel_2.setForeground(new Color(128, 0, 0));
lblNewLabel_2.setFont(new Font("Algerian", Font.BOLD, 46));
lblNewLabel_2.setBounds(41, 53, 1190, 46);
...
lblNewLabel_3_1.setForeground(new Color(255, 0, 255));
lblNewLabel_3_1.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 22));
lblNewLabel_3_1.setBounds(914, 222, 111, 16);
panel.add(lblNewLabel_3_1);
JLabel lblNewLabel_1_1 = new JLabel("INSTRUCTOR:");
lblNewLabel_1_1.setForeground(new Color(0, 204, 153));
lblNewLabel_1_1.setFont(new Font("Times New Roman", Font.BOLD, 20));
lblNewLabel_1_1.setBounds(511, 475, 145, 29);
panel.add(lblNewLabel_1_1);
JLabel lblNewLabel_1_1_1 = new JLabel("MRS. JANANEE");
lblNewLabel_1_1_1.setForeground(new Color(0, 204, 153));
lblNewLabel_1_1_1.setFont(new Font("Times New Roman", Font.BOLD, 20));
lblNewLabel_1_1_1.setBounds(502, 514, 171, 29);
panel.add(lblNewLabel_1_1_1);
JLabel lblNewLabel_4 = new JLabel("New label");
lblNewLabel_4.setFont(new Font("Tahoma", Font.PLAIN, 19));
lblNewLabel_4.setIcon(new ImageIcon("D:\\images\\DKD.png"));
lblNewLabel_4.setBounds(-158, -27, 1461, 681);
